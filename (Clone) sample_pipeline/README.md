...
This folder defines all source code for the 'sample_pipeline' pipeline:
...
* Take a look at the sample under "sample_users_sample_pipeline.sql" to get familiar with the syntax.
